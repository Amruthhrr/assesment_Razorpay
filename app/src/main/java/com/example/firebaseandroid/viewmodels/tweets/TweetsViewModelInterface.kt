...
interface TweetsViewModelInterface {
    ...
    fun editTweet(tweetId: String, updatedTweet: Tweet, onSuccess: () -> Unit, onFailure: (Exception) -> Unit)
    fun deleteTweet(tweetId: String, onSuccess: () -> Unit, onFailure: (Exception) -> Unit)
}